...
let EditProfile = () => {
  ...
  const convertBase64 = (file) => {
    return new Promise((resolve, reject) => {
     ...
     const getProfile = async (userPassed) => {
       let { status, data } = await axios.get("https://devconnect-backend-nno6.onrender.com/api/profiles/me", {
         headers: {
 ...
 await axios.put("https://devconnect-backend-nno6.onrender.com/api/profiles/", localProfile, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devconnect")}`,
      },
