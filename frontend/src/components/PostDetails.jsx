...
let PostDetails = () => {
 ...
 useEffect(() => {
  ...
  function timeDifference(current, previous) {
    ...
    const getUser = async () => {
     let { data } = await axios.get("https://devconnect-backend-nno6.onrender.com/api/users/me", {
       headers: {
  ...
  let getPost = async() =>{
    let { data } = await axios.get(`https://devconnect-backend.onrender.com/api/posts/${postId}`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devconnect")}`,
      },
  ...
  let submitCreateComment = async(e) => {
    e.preventDefault();
    await axios.post(`https://devconnect-backend.onrender.com/api/posts/comment/${postId}`, comment, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devconnect")}`,
      },
  ...
  let clickDeleteComment = async(commentId) => {
    ...
    await axios.delete(`https://devconnect-backend.onrender.com/api/posts/comment/${postId}/${commentId}`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devconnect")}`,
      },
